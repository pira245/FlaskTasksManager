...
app = Flask(__name__, template_folder='core_package/templates')
...
if __name__ == '__main__':
    ...
    app.run(debug=False)  # El debug =True hace que cada vez que reiniciemos el servidor o odifiquemos codigo,
